...
To determine whether or not the salary received is related to benefits obtained, we ran a t-test as our hypothesis test of size 0.05 where we considered a null hypothesis that indicates no relation between our response and predictor variables and an alternative hypothesis that indicates our response and predictor variables are related. In our study, that null hypothesis would be concluding that the amount of annual salary an employee gets has no relation to the benefits they receive. The alternative hypothesis would conclude that the amount of benefits an employee receives is related to their salary. To determine how much a change in salary would impact benefits we looked into the estimated slope for the salary, our predictor variable, in our model.
